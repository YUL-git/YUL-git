...
|PERIOD|TITLE|설명|
|---|---|---|
|2024.07.01~<br>2025.06.31|지능형 비전 검사 시스템을 위한 다차원 이미지 데이터 기반 멀티모달 머신비전 기술 및 의사결정 지원 시스템 개발|한국연구재단 후원 석사과정지원|
|2024.05.31~<br>2024.10.31|대규모 멀티모달 AI 를 활용한 영상 검색 시스템 개발|SKT 주관 SKT AI Fellowship 6기|
